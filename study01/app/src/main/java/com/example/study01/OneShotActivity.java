...
public class OneShotActivity extends Activity implements View.OnClickListener {
    ...
    private final String TAG = "OneShotActivity";
     ...
     */
    private void initUI() {
        findViewById(R.id.btn_oneshot).setOnClickListener(OneShotActivity.this);
        findViewById(R.id.btn_stop).setOnClickListener(OneShotActivity.this);
        findViewById(R.id.btn_grammar).setOnClickListener(OneShotActivity.this);
